      ...
      <div class="container">
        ...
        <div class="intro h-100">
            <div class="row h-100 align-items-center">
              ...
              <div class="col-md-5">
                  <img src="/images/svg/profile.svg" width="300" alt="" class="img-fluid">
              </div>
            </div>
          </div>
...
// R E A D I N G  D A T A for current User
  firestore(){
